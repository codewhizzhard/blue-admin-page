...
const productSchema = z.object({
        categoryId: z.string().min(2, "Product category must be at least 2 characters long").max(50, "Product category must be at most 50 characters long"),
        information: z.object({
            ...
            sizeAndDimension: z.array(z.enum(["XS", "MX", "LX", "XLX"])).optional(),

            clothingReadyToWearSizes: z.object({
                standardClothingSize: z.array(z.enum([
            "XS (Extra Small)",
            "S (Small)",
            "M (Medium)",
            "L (Large)",
            ...
            "XXXL (3XL)"
                ...
                shoeSizes: z.array(z.enum(["EU 36-46", "UK 3-12", "US 4-6"])).optional(),
                kidsSizes: z.array(z.enum(["0-3 months", "3-6 months", "6-12 months", "1-2 years", "3-4 years", "5-6 years"])).optional(),
            }).optional(),

            homeInteriorAndProductSizes: z.object({
                furnitureDimensions: z.array(z.enum(['Small (2-seater)','Medium (3-seater)','Large (4-seater)'])).optional(),
                curtainsABlindSizes: z.array(z.enum(['Standard Window (4ft x 5ft)','Large Window (6ft X 7ft)','Extra Large (8ft x 9ft)'])).optional(),
                beddingAndMattressSizes: z.array(z.enum(['Twin','Full','Queen','King'])).optional(),
                RugsAndCarpetsDimension: z.array(z.enum(['Small (3ft x 5ft)','Medium (5ft X 7ft)','Large (8ft x 10ft)'])).optional(),
            }).optional(),
            })
